    ...
    <div class="container">
        ...
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            <div class="col-md-12 d-flex align-items-center">
                ...
                &nbsp;
                <a href="https://br.linkedin.com/in/kau%C3%AA-gomes-fenerick" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
                 - <strong>Kauê Gomes Fenerick</strong>
                </a>
            </div>
        </footer>
        {{-- RODAPÉ --}}
